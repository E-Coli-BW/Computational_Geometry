...
'''
 Methods related to LeastSquareFit
...
class LeastSquareFit(object):
    ...
    def visulizePlane(self,blob):
        '''
        args: data returned by fitPlane method
        return: None
        functionality: visualize the point data
            i.e:    accept data returned by fitPlane, which is
    ...
    def Pointerize(self,blob):
        '''
        args: return value of the fitPlane method
        return: pointerized data
        '''
        data=blob[0]
        pointerized=[]
...
if __name__ == "__main__":
    ...
    if entry point is here(ie: run this file alone)
    the test code below will be executed
    '''
