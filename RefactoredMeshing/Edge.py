...
class Edge(object):
	...
	#TO BE DONE
	# leastSquaredPlane for this edge
	def leastSquaredPlane(self):
		# common nn of start and end plus start and end itself
		# fit a Plane using leastSquared metric
		# common nn: coNN=commonNeighbors(start,end)
		# coNN would be an list of Points
		pass
	...
	# make my edge vectorized: i.e: look like a Point!
	def vectorize(self):
